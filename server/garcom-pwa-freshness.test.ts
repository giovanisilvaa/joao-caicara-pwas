...
describe("atualizacao do PWA do Garcom", () => {
  ...
  it("publica o fluxo seletivo do Rodízio no PWA do Garçom", () => {
    const sw = read("client/public/garcom/service-worker.js");
    expect(sw).toContain("const RODIZIO_SELECT_ASSET = '/garcom/rodizio-seletivo-v1.js?v=3'");
    expect(sw).toContain("RODIZIO_SELECT_ASSET");
