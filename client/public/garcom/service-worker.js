...
const GARCOM_RESTRICTIONS_ASSET = '/garcom/restricoes-operacionais.js?v=4';
...
const RODIZIO_SELECT_ASSET = '/garcom/rodizio-seletivo-v1.js?v=3';
...
const respostaHtmlComHotfix = async (response) => {
  ...
  if (!html.includes('/garcom/menu-compact-v1.css')) html = html.replace('</head>', '<link rel="stylesheet" href="/garcom/menu-compact-v1.css?v=1"></head>');
  ...
  html = html.replaceAll('<script src="/garcom/restricoes-operacionais.js?v=3"></script>', '');
  if (!html.includes('restricoes-operacionais.js?v=4')) html = html.replace('</body>', '<script src="/garcom/restricoes-operacionais.js?v=4"></script></body>');
  ...
  html = html.replaceAll('<script src="/garcom/rodizio-seletivo-v1.js?v=2"></script>', '');
  if (!html.includes('/garcom/rodizio-seletivo-v1.js?v=3')) html = html.replace('</body>', '<script src="/garcom/rodizio-seletivo-v1.js?v=3"></script></body>');
