const CACHE_NAME = 'joao-caicara-garcom-v13';
const APP_SHELL = ['/garcom/', '/garcom/manifest.json', '/garcom/access-control.js', '/garcom/shared-login.js', '/garcom/access-diagnostics.js', '/garcom/hotfix-sync.js', '/garcom/modern-hybrid.css', '/garcom/waiter-speed.js', '/garcom/waiter-speed.css', '/tradicao-caicara-logo.webp'];
