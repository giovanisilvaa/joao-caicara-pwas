const CACHE_NAME = 'joao-caicara-pdv-v28-report-v29-live-v30-print-v31-menu-v32-half-v33-cancel-v34-staged-v35-transfer-v36-reports-v37-checkoutprint-v38-comanda-v39-visible-v40';
...
const COMANDA_VISIBLE_ASSET = '/pdv/comanda-visible-v2.js?v=2';
...
const respostaHtmlComHotfix = async (response) => {
  ...
  if (!html.includes('/pdv/comanda-visible-v2.js')) html = html.replace('</body>', '<script src="/pdv/comanda-visible-v2.js?v=2"></script></body>');
