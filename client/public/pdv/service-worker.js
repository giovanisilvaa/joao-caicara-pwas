...
const APP_SHELL = ['/pdv/', '/pdv/manifest.json', '/pdv/access-control.js?v=30', '/pdv/admin-login.js?v=29', '/pdv/access-diagnostics.js?v=30', '/pdv/pdv-sync.js', '/pdv/pdv-safety.js', '/pdv/pdv-operations.js', '/pdv/pdv-checkout-core.js', '/pdv/waiter-sales-report.js?v=27', '/pdv/service-fee-shifts.js?v=28', '/pdv/pdv-production.js', '/pdv/modern-hybrid.css', '/pdv/fast-checkout.js', '/pdv/fast-checkout.css', '/pdv/fast-split.js', '/pdv/fast-split.css', '/tradicao-caicara-logo.webp'];
const respostaHtmlComHotfix = async (response) => {
  ...
  if (!html.includes('/pdv/access-control.js')) html = html.replace('</body>', '<script src="/pdv/access-control.js?v=30"></script></body>');
